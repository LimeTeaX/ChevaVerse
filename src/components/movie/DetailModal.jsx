...
import { X, Star, Clock, Calendar, Tv, Plus, CheckCheck, ExternalLink } from 'lucide-react';
...
export default function DetailModal({ item, onClose }) {
  ...
  return (
    <>
      ...
      >
        <div
          className="relative max-w-3xl w-full max-h-[88vh] overflow-y-auto rounded-[24px] bg-[#0F1A36] border border-white/[0.08] shadow-2xl animate-fadeInScale"
        ...
        >
          ...
          <div className="px-6 pb-6 -mt-10 relative z-10">
            ...
            {/* Tombol Actions - 3 Tombol */}
            <div className="flex flex-col sm:flex-row gap-3 mt-6">
              {/* Tombol Watch Now - Buka modal streaming */}
              <button
                onClick={() => setShowStreamingModal(true)}
                className="flex-1 flex items-center justify-center gap-2 bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700 text-white py-3 rounded-xl font-semibold text-[14px] transition-all"
              >
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl font-semibold text-[14px] transition-all ${
                  isInWatchlist
