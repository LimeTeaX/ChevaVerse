...
import { signIn, signUp } from '../services/pocketbase';
    ...
    return (
        <div className="min-h-screen bg-[#0A1628] flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-cyan-500/20 to-gold-500/20 flex-col justify-center px-12 relative overflow-hidden">
                {/* Tombol Back ke Landing Page - di kiri atas */}
                <Link
                    to="/"
                    className="absolute top-8 left-8 z-20 flex items-center gap-2 text-gray-400 hover:text-cyan-400 transition-colors"
                >
                    <ArrowLeft size={18} />
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center px-4 py-8">
                <div className="max-w-md w-full glass-card rounded-2xl p-8">
                    {/* Tombol Back ke Landing Page - untuk mobile */}
